...
mod tests
{
  ...
  fn test_1()
  {
    ...
    assert_eq!(vec![Content::Int(360)], attempt(&available, &allowed, &preferred));
  }
  ...
  fn test_2()
  {
    ...
    assert_eq!(vec![Content::Int(720)], attempt(&available, &allowed, &preferred));
  }
  ...
  fn test_3()
  {
    ...
    assert_eq!(Vec::<Content>::new(), attempt(&available, &allowed, &preferred));
  }
  ...
  {
    let available = [Content::Int(240), Content::Int(360), Content::Int(720)];
    let allowed = [Content::Int(240), Content::Int(360), Content::Int(720), Content::Int(1080)];
  ...
  fn test_6()
  {
    ...
    assert_eq!(vec![Content::Int(240)], attempt(&available, &allowed, &preferred));
  }
